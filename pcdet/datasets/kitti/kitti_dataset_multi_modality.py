...
class KittiDatasetMultiModality(DatasetTemplate):
    ...
    def get_lidar(self, idx):
        lidar_file = self.root_split_path / 'velodyne_depth' / ('%s.npy' % idx)
...
def create_kitti_infos(dataset_cfg, class_names, data_path, save_path, workers=4):
    dataset = KittiDatasetMultiModality(dataset_cfg=dataset_cfg, class_names=class_names, root_path=data_path, training=False)
